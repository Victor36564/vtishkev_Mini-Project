...
model1_all = model_1.predict(allnumbers_images_reshaped)
print_numbers(allnumbers_images , model1_all)
...
print("The overall results of the K-NeighborsClassifier model is " + str(Model2_Overall_Accuracy))

model2_all = model_2.predict(allnumbers_images_reshaped)
print_numbers(allnumbers_images , model2_all)

#Repeat for the MLP Classifier
model_3 = MLPClassifier(max_iter=500, random_state=0)
...
print("The overall results of the MLPClassifier model is " + str(Model3_Overall_Accuracy))

model3_all = model_3.predict(allnumbers_images_reshaped)
print_numbers(allnumbers_images , model3_all)
...
model1_results_poison = model_1.predict(X_test_reshaped)

Model1_Overall_Accuracy_poison = OverallAccuracy(model1_results_poison, y_test)
print("")
print("The poisoned results of the Gaussian model is " + str(Model1_Overall_Accuracy_poison))

model_2.fit(X_train_poison_reshaped, y_train)
model2_results_poison = model_2.predict(X_test_reshaped)

Model2_Overall_Accuracy_poison = OverallAccuracy(model2_results_poison, y_test)
print("The poisoned results of the K-NeighborsClassifier model is " + str(Model2_Overall_Accuracy_poison))

model_3.fit(X_train_poison_reshaped, y_train)
model3_results_poison = model_3.predict(X_test_reshaped)

Model3_Overall_Accuracy_poison = OverallAccuracy(model3_results_poison, y_test)
print("The poisoned results of the MLPClassifier model is " + str(Model3_Overall_Accuracy_poison))
...
denoised_fit = kernel_pca.fit_transform(X_train_poison_reshaped)
X_train_denoised = kernel_pca.inverse_transform(denoised_fit)
...
model_1.fit(X_train_denoised_reshaped, y_train)
model1_results_denoised = model_1.predict(X_test_reshaped)

Model1_Overall_Accuracy_denoised = OverallAccuracy(model1_results_denoised, y_test)
print("")
print("The denoised results of the Gaussian model is " + str(Model1_Overall_Accuracy_denoised))

model_2.fit(X_train_denoised_reshaped, y_train)
model2_results_denoised = model_2.predict(X_test_reshaped)

Model2_Overall_Accuracy_denoised = OverallAccuracy(model2_results_denoised, y_test)
print("The denoised results of the K-NeighborsClassifier model is " + str(Model2_Overall_Accuracy_denoised))

model_3.fit(X_train_denoised_reshaped, y_train)
model3_results_denoised = model_3.predict(X_test_reshaped)

Model3_Overall_Accuracy_denoised = OverallAccuracy(model3_results_denoised, y_test)
print("The denoised results of the MLPClassifier model is " + str(Model3_Overall_Accuracy_denoised))

# Function to display digits from the poisoned, denoised, and original training data sets
# def print_numbers_comparison(noisy_images, denoised_images, original_images):
#     denoised_images = denoised_images.reshape(-1,8,8)
#     for i in range(10):
#         # Show noisy image
...
#         plt.show()
#
# print_numbers_comparison(X_train_poison, X_train_denoised,X_train)